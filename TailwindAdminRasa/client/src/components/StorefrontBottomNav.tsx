...
import { Home, Grid3X3, ShoppingCart, User, Heart, Search } from 'lucide-react';
        ...
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              {/* Active indicator */}
              {isActive && (
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-8 h-0.5 bg-green-600 rounded-full" />
              )}
            </button>
          );
        })}
